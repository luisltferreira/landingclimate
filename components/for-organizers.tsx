      ...
      <div className="max-w-5xl mx-auto" ref={ref}>
        <div className={`bg-white rounded-2xl p-6 sm:p-8 md:p-12 lg:p-16 shadow-sm border border-gray-100 transition-all duration-700 hover-lift hover:shadow-xl hover:border-[#d5ffa1]/30 group ${isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#d5ffa1] rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg group-hover:shadow-[#d5ffa1]/30">
              <Zap size={24} className="sm:w-8 sm:h-8 text-[#191919] transition-transform duration-300 group-hover:scale-110" />
            </div>
          ...
          {/* Description */}
          <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-6 sm:mb-10 leading-relaxed max-w-3xl transition-colors duration-300 group-hover:text-gray-800">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#d5ffa1]/20 to-transparent opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
          </a>
        </div>
      </div>
    </section>
